...
//       <div className="bg-white mx-2 rounded-xl shadow-lg hover:shadow-xl shadow-indigo-600 hover:shadow-indigo-600 mt-5  grid  grid-cols-1 items-center  px-2  sm:py-5 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
//         <div>
//           <div>
